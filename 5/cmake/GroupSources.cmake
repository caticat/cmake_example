...
macro(GroupSources dir)
  ...
  if (NOT ${WITH_SOURCE_TREE} STREQUAL "")
    ...
    foreach(element ${elements})
      ...
      # message(STATUS "element_name:" ${element_name})
      # message(STATUS "element_dir:" ${element_dir})
...
#          message(STATUS "group_name:" ${element_dir})
#          message(STATUS "dst:" ${dir}/${element})
        endif()
      else()
